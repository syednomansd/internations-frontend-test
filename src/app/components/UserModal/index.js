...
class UserModal extends Component {
  ...
  handleSubmit(e) {
    e.preventDefault();
    const { fullname, email, group, type, usermodal } = this.state;
    if(!fullname){
      ...
      this.setState({loading: true}, function(){
        if(type === "add"){
          ...
          this.props.updateUser(usermodal._id, {fullname, email, group});
        }
      })
    }
  }
  ...
  render() {
    ...
    const { usermodal, type, msgContent, msgType, fullname, email, loading } = this.state;
    return(
      <div className={usermodal ? 'modal' : 'modal-close'}>
        <div className="modal-dialog modal-box" ref={this.setModalRef}>
